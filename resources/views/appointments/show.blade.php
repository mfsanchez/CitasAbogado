      ...
      <div class="row align-items-center">
        ...
        <div class="card-body">   
        	<ul>
        		...
        		<li>
        			<strong>Funcionario:</strong>{{ $appointment->doctor->name}}
        		</li>
        		@endif
        		
        		@if ($role == 'doctor'|| $role == 'admin')
        		<li>
        			<strong>Ciudadano:</strong>{{ $appointment->patient->name}}
        		</li>
        		@endif

        		<li>
        			<strong>Departamento:</strong>{{ $appointment->specialty->name}}
        		</li> 
        		<li>
