        ...
        <div class="card-body">
          ...
          <div class="alert alert-success" role="alert">
            {{session('notification') }}
              ...
              @if ($role == 'patient')
              <p>
                Estas a punto de cancelar tu cita reservada para 
                {{ $appointment->doctor->name}} 
                (departamento {{$appointment->specialty->name}}) 
              ...
              @else
              <p>
                Estas a punto de cancelar la cita reservada para
                por el ciudadano  {{ $appointment->patient->name}} 
                para atendido por el funcionario {{$appointment->doctor->name}}
                (departamento {{$appointment->specialty->name}}) 
